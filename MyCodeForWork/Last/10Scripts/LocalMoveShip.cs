...
////Так как на работе у меня нет интернета и я не могу докачивать нужные компоненты, пишу скрипт как он должен работать для локальной игры
////На объект "ship" вешаются компоненты UNET - Network Identity и Network Transform, а на объект ForScripts компонент Network Manager

//public class LocalMoveShip : NetworkBehaviour
//{
//    [SerializeField]
